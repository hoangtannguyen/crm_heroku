                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <input name="note" type="text" class="form-control" value="{{ $repairs->note }}" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{ $repairs->phone }}" class="form-control" data-error="{{ __('Vui lòng nhập số điện thoại')}}" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
