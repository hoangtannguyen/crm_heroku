...
@section('title',__('Cập nhật vật tư theo phiếu'))
@section('content')
@php 
    ...
    <section class="content">
        <div class="container">
            <div class="head">
                ...
                <h1 class="title">{{ __('Cập nhật vật tư theo phiếu') }}</h1>
            </div>
            <div class="main">
                @include('notices.index')
                <form action="{{ route('supplieBallot.put',$ballots->id) }}" data-filter="{{ route('supplieBallot.table') }}" class="dev-form" method="POST" data-toggle="validator" role="form">
                    @csrf
                    @method('PUT')
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    ...
                                    <tbody class="ballot_device">
                                        @foreach($ballots->supplies as $key => $ballot)
