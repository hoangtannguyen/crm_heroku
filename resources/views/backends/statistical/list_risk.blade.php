      ...
      <div class="main">
         <div class="row search-filter">
            <div class="col-md-4 filter">
               <ul class="nav-filter">
                  <li class=""><a class="btn btn-success" style="color: #fff;" href="{{ route('statistical.exportRisk',['risk'=>$risk, 'key'=>$keyword]) }}"><i class="far fa-file-excel"></i> {{ _('Xuất Excel') }}</a></li>
               </ul>
            </div>
                    ...
                    <div class="col-md-6">
                        <select class="form-control select2"  name="risk">
                             ...
                             @foreach ($get_statusRisk as $key => $items)
                                 <option value="{{ $key }}" {{ $risk ==  $key ? 'selected' : '' }} >{{ $items }}</option>
                             @endforeach
                         </select>   
                     </div>             
         ...
         <div class="card">
            <div class="card-body p-0">
               ...
               <form class="dev-form" action="{{ route('statistical.risk') }}" name="equipment_department" method="GET">
                  @csrf
               ...
               <form action="{{ route('statistical.risk') }}" class="equipments" name="equipments_department" method="GET">
