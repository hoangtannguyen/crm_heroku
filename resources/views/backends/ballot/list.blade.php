                       ...
                       <tr>
                          ...
                          @if($ballot->status == "public")
                             <td class="text-center">
                                <a class="mr-1 ml-1" title="Cập nhật thiết bị" href="{{ route('ballot.edit',$ballot->id) }}">
                                   <i class="fas fa-edit"></i>
                                </a>
                                <a class="text-danger" title="Xóa thiết bị" href="{{ route('ballot.delete',$ballot->id) }}" data-toggle="modal" data-target="#sideModal" data-direct="modal-top-right"><i class="fas fa-trash"></i>
                                </a>
                             </td>
                          @else
                          <td class="text-center">
                             <a  title="Cập nhật thiết bị" href="{{ route('ballot.edit',$ballot->id) }}">
                                <i class="fas fa-edit"></i>
                             </a>
                             <a class="text-success ballot-success mr-1 ml-1" title="Duyệt phiếu" data-title="{{ $ballot->ballot }}" data-href="{{ route('ballot.updateSuccess',$ballot->id) }}">
