      ...
      <div class="main">
         <div class="row search-filter">
            <div class="col-md-2 filter">
               <ul class="nav-filter">
                  <li class=""><a class="btn btn-success" style="color: #fff;" href="{{ route('general.exportLiquidations',['departments_id'=>$departments_id, 'startDate'=>$startDate, 'endDate'=>$endDate, 'key'=>$keyword]) }}"><i class="far fa-file-excel"></i> {{ _('Xuất Excel') }}</a></li>
               </ul>
            </div>
                        ...
                        @if(!$equipments->isEmpty())
                           @foreach($equipments as $key => $equipment)
                                 <tr class="text-center">
                                    ...
                                    <td><a href="{{ route('eqliquis.listLiqui',['equip_id'=>$equipment->id]) }}">{{ $equipment->code != null ? $equipment->code : '-' }}</a></td>
                                    <td><a href="{{ route('eqliquis.listLiqui',['equip_id'=>$equipment->id]) }}">{{ $equipment->title != null ? $equipment->title : '-' }}</a></td>
                                    ...
                                    <td>{{ $equipment->liquidations_count }}</td>
                                 </tr>
